...
class A2CAgent(a2c_common.ContinuousA2CBase):
    ...
    def __init__(self, base_name, params):
        ...
        if self.normalize_value:
            ...
            if self.use_int:
                self.value_mean_std_int = self.central_value_net.model.value_mean_std_int if self.has_central_value else self.model.value_mean_std_int
    ...
    def calc_gradients(self, input_dict):
        ...
        advantage = input_dict['advantages_mixed'] if self.use_int \
            else input_dict['advantages']
        ...
        with torch.cuda.amp.autocast(enabled=self.mixed_precision):
            ...
            if self.has_value_loss:
                ...
                if 'values_int' in res_dict:
                    c_loss = c_loss + common_losses.critic_loss(self.model, input_dict['old_values_int'], res_dict['values_int'], 
