...
if __name__ == '__main__':
    ...
    ap.add_argument("--use_pbrs", required=False, action='store_true')
    ap.add_argument("--use_hurl", required=False, action='store_true')
    ap.add_argument("--use_switch", required=False, action='store_true')
    ap.add_argument("--use_hepo", required=False, action='store_true')
    ap.add_argument("--use_bad_reward", required=False, action='store_true')
    ap.add_argument("--use_human_design_reward", required=False, action='store_true')
    ap.add_argument("--lmbd", type=float, default=-1, required=False)
    ap.add_argument("--alpha", type=float, default=0., required=False)
    ap.add_argument("--alpha_lr", type=float, default=0.001, required=False)
    ap.add_argument("--ext_scheme", default='total', required=False)
    ap.add_argument("--int_scheme", default='zero', required=False)
    ap.add_argument("--ref_scheme", default='hepo', required=False)
